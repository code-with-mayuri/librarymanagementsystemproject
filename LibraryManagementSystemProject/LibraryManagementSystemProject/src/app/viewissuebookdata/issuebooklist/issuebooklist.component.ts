...
import { IssuebookserviceService } from 'src/app/service/issuebook.service';

@Component({
  selector: 'app-issuebooklist',
  templateUrl: './issuebooklist.component.html',
  styleUrls: ['./issuebooklist.component.css']
})
